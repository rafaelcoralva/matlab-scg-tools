function [avg_max_over_median_diameter] = anisotropy_calculator_avg_max_over_median_diameter(fs,r_pos,scg_xyz)
...
% OUTPUT:
% avg_max_over_median_diameters = indicator of anisotropy.
...
max_over_median_diameters = zeros(1,length(r_pos));
...
for i = 1:length(r_pos)
    ...
    max_over_median_diameters(i) = max_diameter/median_diameter;
       
end

avg_max_over_median_diameter = mean(max_over_median_diameters);
