function [max_over_median_diameter] = cardiac_max_s1p2p_axis_finder(scg_xyz)
% This function calculates a simple index of anisotropy of the input x/y/z acceleration trajectory (e.g., avg S1 complex):
% - The ratio of 3D acceleration trajetctory max diameter over its median diamater. 
...
% OUTPUT:
% max_over_median_diameter (scalar) - Indicator of anisotropy.

% DESCRIPTION:
% Part 1. Calculation of the 3D hull surface and its volume using the MATLAB 'boundary' function.
% Part 2. Identification the maximum and median antipodal distances (i.e. diameter) of the surface.
% Part 3. Computation of ratio of these.
...
% Finding median diameter.
median_diameter = median(diameter_sph_mat,'all');


%% 3. Calculating anisotropy index.
max_over_median_diameter = max_diameter/median_diameter;
